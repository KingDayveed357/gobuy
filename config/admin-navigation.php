...
return [
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Campaigns', 'route' => 'admin.campaigns.index', 'active' => ['admin.campaigns.*']],
            ['label' => 'Pages', 'route' => 'admin.pages.index', 'active' => ['admin.pages.*']],
            // ['label' => 'Page content', 'route' => 'admin.merchandising.index', 'active' => ['admin.merchandising.*']],
            ...
            ['label' => 'Sale prices', 'route' => 'admin.promotions.index', 'active' => ['admin.promotions.*']],
