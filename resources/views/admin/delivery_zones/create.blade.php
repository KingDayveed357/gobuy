...
@section('title', 'Add Delivery Zone — Quintessential Mart admin')
...
@section('content')
    ...
    <x-admin.page-header title="Add Delivery Zone" />
            ...
            <form action="{{ route('admin.delivery-zones.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('states') is-invalid @enderror" id="states" name="states" value="{{ old('states') }}" placeholder="Lagos, Abuja, Rivers">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('base_fee') is-invalid @enderror" id="base_fee" name="base_fee" value="{{ old('base_fee', 0) }}" min="0" step="0.01" required>
                        @error('base_fee')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label" for="per_kg_fee">Per Kg Fee (₦)</label>
                        <input type="number" class="form-control @error('per_kg_fee') is-invalid @enderror" id="per_kg_fee" name="per_kg_fee" value="{{ old('per_kg_fee', 0) }}" min="0" step="0.01" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('free_over_subtotal') is-invalid @enderror" id="free_over_subtotal" name="free_over_subtotal" value="{{ old('free_over_subtotal') }}" min="0" step="0.01">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary"><span class="fas fa-save me-2"></span>Save Zone</button>
                </div>
            </form>
        </div>
    </div>
